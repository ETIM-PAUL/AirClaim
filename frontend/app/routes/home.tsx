...
const App: React.FC = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      title: "Easy Claims",
      description: "We handle all the process with airlines. Once a delay is detected, the claim process can be completed in just a few clicks.",
      gradient: "from-blue-500 to-cyan-600"
    },
    {
      icon: <FaRocket className="text-3xl" />,
      title: "FLR Token Rewards",
      description: "Win FLR tokens by predicting a lucky number during the claim process. Add excitement to an otherwise frustrating delay!",
    ...
    },
    {
      ...
      description: "Receive compensation directly to your wallet as soon as your claim is approved.",
  ...
  const steps = [
    {
      number: "01",
      title: "Insure Flights",
      description: "Enter your airline flight details in the app and purchase affordable insurance coverage in seconds.",
      icon: <MdOutlineFlightTakeoff className="text-2xl" />
    },
    {
      number: "02",
      title: "Monitor Status",
      description: "Our app tracks your flight and alerts you of delays or cancellations.",
      icon: <BiSolidHourglassTop className="text-2xl" />
    },
    {
      number: "03",
      title: "Predict & Win",
      description: "If your flight is delayed, predict lucky number during the claim process for a chance to win FLR tokens.",
      icon: <FaCoins className="text-2xl" />
    },
    {
      number: "04",
      title: "Collect Payment",
      description: "Receive your compensation and any token rewards directly to your wallet account.",
  ...
  return (
    <div className="bg-gradient-to-br from-gray-900 via-black to-gray-900 text-white font-sans min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <button className="bg-gradient-to-r cursor-pointer from-green-400 to-emerald-500 text-black px-8 py-4 rounded-xl font-semibold hover:shadow-lg hover:shadow-green-500/25 transition-all duration-300 transform hover:scale-105">
                  Get Started
                </button>
                <button className="border-2 border-green-400 cursor-pointer text-green-400 px-8 py-4 rounded-xl font-semibold hover:bg-green-400 hover:text-black transition-all duration-300">
                  Learn About
                </button>
              </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <ul className="list-disc list-inside text-gray-300 space-y-2">
              <li>Predict a lucky number during your claim process</li>
              <li>If your number is drawn, you win FLR tokens, otherwise, you lose 50% of your Insurance Claim</li>
              <li>Tokens are sent directly to your wallet within seconds</li>
              <li>No additional cost - included with every insurance claim</li>
            </ul>
            <button className="cursor-pointer bg-gradient-to-r from-purple-400 to-pink-500 text-black px-8 py-4 rounded-xl font-semibold hover:shadow-lg hover:shadow-purple-500/25 transition-all duration-300 transform hover:scale-105">
          ...
          <div className="relative">
            <div className="relative w-80 h-96 mx-auto">
              ...
              <div className="relative bg-gradient-to-br from-gray-600 to-gray-700 rounded-3xl p-6 shadow-2xl">
                ...
                <p className="text-sm text-gray-400 mb-2">Prize: 5 FLR</p>
                <p className="text-sm text-gray-400 mb-2">Select your prediction number:</p>
      ...
      <section className="max-w-7xl mx-auto px-6 py-20 bg-gradient-to-br from-blue-500/10 to-cyan-500/10">
        ...
        <p className="text-center text-gray-400 mb-12">
          Airclaim provides insurance for various types of flight disruption, ensuring you're always protected.    </p>

        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Testimonial 1 */}
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6 text-left space-y-3">
            <div className="text-green-400 mb-2"><BiSolidHourglassTop className='text-3xl' /></div>
            <h1>Flight Delays</h1>
            <p className="text-gray-300 mb-4">
              Get compensation for delays starting from 1 hour. Still win FLR Tokens, even after the ordeal.
            </p>
          ...
          {/* Testimonial 2 */}
          <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-6 text-left space-y-3">
            <div className="text-green-400 mb-2"><TbCancel className='text-3xl' /></div>
            <h1>Cancellations</h1>
            <p className="text-gray-300 mb-4 ">
