...
import IFlareContractRegistry from "../../getters_artifacts/coston2/IFlareContractRegistry.sol/IFlareContractRegistry.json";
import IPriceSubmitter from "../../getters_artifacts/coston2/IPriceSubmitter.sol/IPriceSubmitter.json";
import IGovernanceSettings from "../../getters_artifacts/coston2/IGovernanceSettings.sol/IGovernanceSettings.json";
import IFtsoRewardManager from "../../getters_artifacts/coston2/IFtsoRewardManager.sol/IFtsoRewardManager.json";
import IFtsoRegistry from "../../getters_artifacts/coston2/IFtsoRegistry.sol/IFtsoRegistry.json";
import IVoterWhitelister from "../../getters_artifacts/coston2/IVoterWhitelister.sol/IVoterWhitelister.json";
import IFtsoManager from "../../getters_artifacts/coston2/IFtsoManager.sol/IFtsoManager.json";
import IWNat from "../../getters_artifacts/coston2/IWNat.sol/IWNat.json";
import IGovernanceVotePower from "../../getters_artifacts/coston2/IGovernanceVotePower.sol/IGovernanceVotePower.json";
import IClaimSetupManager from "../../getters_artifacts/coston2/IClaimSetupManager.sol/IClaimSetupManager.json";
import IFlareAssetRegistry from "../../getters_artifacts/coston2/IFlareAssetRegistry.sol/IFlareAssetRegistry.json";
import ISubmission from "../../getters_artifacts/coston2/ISubmission.sol/ISubmission.json";
import IEntityManager from "../../getters_artifacts/coston2/IEntityManager.sol/IEntityManager.json";
import IVoterRegistry from "../../getters_artifacts/coston2/IVoterRegistry.sol/IVoterRegistry.json";
import IFlareSystemsCalculator from "../../getters_artifacts/coston2/IFlareSystemsCalculator.sol/IFlareSystemsCalculator.json";
import IFlareSystemsManager from "../../getters_artifacts/coston2/IFlareSystemsManager.sol/IFlareSystemsManager.json";
import IRewardManager from "../../getters_artifacts/coston2/IRewardManager.sol/IRewardManager.json";
import IRelay from "../../getters_artifacts/coston2/IRelay.sol/IRelay.json";
import IWNatDelegationFee from "../../getters_artifacts/coston2/IWNatDelegationFee.sol/IWNatDelegationFee.json";
import IFtsoInflationConfigurations from "../../getters_artifacts/coston2/IFtsoInflationConfigurations.sol/IFtsoInflationConfigurations.json";
import IFtsoRewardOffersManager from "../../getters_artifacts/coston2/IFtsoRewardOffersManager.sol/IFtsoRewardOffersManager.json";
import IFtsoFeedDecimals from "../../getters_artifacts/coston2/IFtsoFeedDecimals.sol/IFtsoFeedDecimals.json";
import IFtsoFeedPublisher from "../../getters_artifacts/coston2/IFtsoFeedPublisher.sol/IFtsoFeedPublisher.json";
import IFtsoFeedIdConverter from "../../getters_artifacts/coston2/IFtsoFeedIdConverter.sol/IFtsoFeedIdConverter.json";
import IFastUpdateIncentiveManager from "../../getters_artifacts/coston2/IFastUpdateIncentiveManager.sol/IFastUpdateIncentiveManager.json";
import IFastUpdatesConfiguration from "../../getters_artifacts/coston2/IFastUpdatesConfiguration.sol/IFastUpdatesConfiguration.json";
import IFastUpdater from "../../getters_artifacts/coston2/IFastUpdater.sol/IFastUpdater.json";
import IFeeCalculator from "../../getters_artifacts/coston2/IFeeCalculator.sol/IFeeCalculator.json";
import FtsoV2Interface from "../../getters_artifacts/coston2/FtsoV2Interface.sol/FtsoV2Interface.json";
import TestFtsoV2Interface from "../../getters_artifacts/coston2/TestFtsoV2Interface.sol/TestFtsoV2Interface.json";
import ProtocolsV2Interface from "../../getters_artifacts/coston2/ProtocolsV2Interface.sol/ProtocolsV2Interface.json";
import RandomNumberV2Interface from "../../getters_artifacts/coston2/RandomNumberV2Interface.sol/RandomNumberV2Interface.json";
import RewardsV2Interface from "../../getters_artifacts/coston2/RewardsV2Interface.sol/RewardsV2Interface.json";
import IFdcVerification from "../../getters_artifacts/coston2/IFdcVerification.sol/IFdcVerification.json";
import IFdcHub from "../../getters_artifacts/coston2/IFdcHub.sol/IFdcHub.json";
import IFdcRequestFeeConfigurations from "../../getters_artifacts/coston2/IFdcRequestFeeConfigurations.sol/IFdcRequestFeeConfigurations.json";
import IWeb2JsonVerification from "../../getters_artifacts/coston2/IWeb2JsonVerification.sol/IWeb2JsonVerification.json";
import IAssetManagerController from "../../getters_artifacts/coston2/IAssetManagerController.sol/IAssetManagerController.json";
